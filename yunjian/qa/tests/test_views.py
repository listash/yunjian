...
class TestAnsweredQuestionListView(BaseQATest):
    ...
    def test_context_data(self):
        response = self.get(views.AnsweredQuestionView, request=self.request)  # 方式一
...
class TestUnansweredQuestionListView(BaseQATest):
    ...
    def test_context_data(self):
        response = self.get(views.UnansweredQuestionView, request=self.request)  # 方式一
